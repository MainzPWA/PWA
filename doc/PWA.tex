...
parts obtained from the fit.
%\textbf{Note:} After execution of \tt Extract()\rm\ it is recommended to restart
%\tt ROOT\rm\ to avoid problems when drawing \tt TCanvas\rm\ objects. 
\tt Extract()\rm\ must be executed from your work directory (having subdirectories \tt plots.\textit{n}\rm).
