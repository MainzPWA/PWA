...
enum{ NONE = 0, MLP1 = 1, MLP2 = 2, MLP3 = 3, CGLN = 4, HELI = 5 };
enum{ SIG_0  =  0,
      SIG_S  =  1, SIG_T  =  2, SIG_P  =  3,
      SIG_E  =  4, SIG_F  =  5, SIG_G  =  6, SIG_H  =  7,
      SIG_CX =  8, SIG_CZ =  9, SIG_OX = 10, SIG_OZ = 11,
      SIG_LX = 12, SIG_LZ = 13, SIG_TX = 14, SIG_TZ = 15,
      ASY_S  = 16, ASY_T  = 17, ASY_P  = 18,
      ASY_E  = 19, ASY_F  = 20, ASY_G  = 21, ASY_H  = 22,
      ASY_CX = 23, ASY_CZ = 24, ASY_OX = 25, ASY_OZ = 26,
      ASY_LX = 27, ASY_LZ = 28, ASY_TX = 29, ASY_TZ = 30 };
